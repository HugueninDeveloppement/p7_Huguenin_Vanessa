...
function AdminDashBord() {
  ...
  useEffect(() => {
    ...
    {headers:{
      accesToken: localStorage.getItem("accesToken")
         ...
         .then((response)=>{
          setArrayOfPostAlert(response.data.listOfPostsSignalled.PostsSignalleds.length)
  ...
  const deletePost = (data) =>{
    console.log(data.PostsSignalleds.length);
    console.log(data.id);
      ...
      <>
        ...
        <div className="dashbord-contain">
          ...
          {listOfPostsSignalled.map((value, key) => {
            console.log(arrayOfPostAlert.length);
              return (
            <div key={key} className="postWithAlertDashbord">
                ...
                <div className="postText">
                Nombre de signalement : {arrayOfPostAlert}
                </div>
                <div >
