        ...
        <div className="form-register">
            <Formik initialValues={initailValues} onSubmit={onSubmit} validationSchema={validationSchema}>
                <Form className="formRegisterContainer">
                    ...
                    <ErrorMessage name="userPseudo" component="span"/><br/>
                    ...
                    <Field autoComplete="off" id="inputCreateUser" name="userEmail" placeholder="(ex: monemail@serviceintel.fr)"/><br/>
                    <ErrorMessage name="userEmail" component="div" className="form-register-alert"/>
                    </div>
                    <div className="group-form-register">
