        ...
        <div className="form-register">
            <Formik initialValues={initailValues} onSubmit={onSubmit} validationSchema={validationSchema}>
                <Form className="formRegisterContainer">
                    ...
                    <Field autoComplete="off" id="inputCreateUserPseudo" name="userPseudo" placeholder="(ex: Ness973)"/>
                    </div>
                    <div className="group-form-register">
                    <label>Nom de famille: </label>
                    <ErrorMessage name="userName" component="span"/>
                    <Field autoComplete="off" id="inputCreateUserName" name="userName" placeholder="(ex: julie)"/>
                    </div>
                    <div className="group-form-register">                       
                    <label>Mail: </label>                    
                    <Field autoComplete="off" id="inputCreateUserMail" name="userEmail" placeholder="(ex: monemail@serviceintel.fr)"/>
                    ...
                    <Field autoComplete="off" type="password" id="inputCreateUserPassword" name="userPassword" placeholder="(8 caracteres minimum)"/>
                    </div>
