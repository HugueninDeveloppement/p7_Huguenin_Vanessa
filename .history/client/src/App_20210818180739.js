        ...
        <Router>
          ...
          <div className="nav-bar">
              ...
              {!authState.status ? (               
                ...
                <span><Link to="/login" className="link-nav" style={{ textDecoration: 'none', color:'initial'}}>Se connecter</Link></span>
                <span><Link to="/register" style={{ textDecoration: 'none', color:'initial' }}>S'inscrire</Link></span>
                </div>               
              ) : (
              ...
              <button onClick={logout}><Link to="/login">Se Déconnecter</Link> </button>
              </div>
              }
