...
Router.post("/auth", (req, res) => {
    ...
    const emailCrypted =  CryptoJS.HmacSHA256.encrypt(req.body.userEmail, "MyCrypt0Key").toString(); 
...
Router.get("/userAllInfo/:id", validateToken ,async (req, res)=> {
    ...
    const emailDecrypted = await CryptoJS.AES.decrypt(userAllInfo.userEmail, "MyCrypt0Key");
